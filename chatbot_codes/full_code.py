...
data_file=open(os.path.join(os.getcwd(),'intents.json')).read()
...
def get_response(return_list,intents_json):
    ...
    if tag=='news':
        main_url = " https://gnews.io/api/v4/search?q=example&country=france&token=b29110c3d58ce0b820e6d3c68a08e204&lang=en"
